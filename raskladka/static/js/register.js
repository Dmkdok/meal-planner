(function() {
    // Trim username input on submit to avoid accidental leading/trailing spaces
    ...
    // Toggle visibility for each password field with its sibling button
    const wrappers = document.querySelectorAll('.input-with-icon');
    wrappers.forEach(function(wrapper) {
        const input = wrapper.querySelector('input.password-input');
